<?php $__env->startSection('content'); ?>
	<div class="itemnav">
		<div class="title"><h3><?php echo e(trans('user.promotion')); ?></h3></div>
		<ul class="tab">
			<li class="on"><a href="<?php echo e(route('user.promotion.index')); ?>"><span><?php echo e(trans('user.promotion.rule')); ?></span></a></li>
			<li><a href="<?php echo e(route('user.promotion.card')); ?>"><span><?php echo e(trans('user.promotion.card')); ?></span></a></li>
		</ul>
	</div>
	<div class="promotion-tip mtw">
        <p>亲爱的<?php echo e(auth()->user()->username); ?>，感谢你注册并享受知惠网提供的服务。我们会竭诚服务好每一位消费者，请把以下推广链接复制发送给你的朋友或同事，知惠网将给予你一定奖励</p>
	</div>
	<div class="promotion-url mtw">
		<div class="hd">推广链接</div>
        <div class="bd">
            <input id="promotion-url" type="text" class="input copy-link" value="<?php echo e($promotion); ?>" size="50" readonly />
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript" src="<?php echo e(asset('static/js/jquery.zclip.js')); ?>"></script>
    <script type="text/javascript">
        $(function(){
            $(".copy-link").zclip({
                path: "<?php echo e(asset('static/js/ZeroClipboard.swf')); ?>",
