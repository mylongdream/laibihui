<?php $__env->startSection('content'); ?>
	<div class="itemnav">
		<div class="title"><h3><?php echo e(trans('admin.mall.order')); ?></h3></div>
	</div>
	<form id="schform" name="schform" class="formsearch" method="get" action="<?php echo e(route('admin.mall.order.index')); ?>">
	<div class="tbsearch">
		<dl>
			<dd>
	...
	<form id="cpform" name="cpform" class="ajaxform" method="post" action="<?php echo e(route('admin.mall.order.batch')); ?>">
	<?php echo csrf_field(); ?>

	<input type="hidden" id="operate" name="operate" value="" />
	<div class="tblist">
		<div class="tbhead cl">
			<div class="z"><h3><?php echo e(trans('admin.mall.order.list')); ?></h3></div>
		</div>
		<table>
			<tr>
				<th width="24"><input class="checkall" type="checkbox"></th>
				<th width="100"><?php echo e(trans('admin.mall.order.user')); ?></th>
				<th width="160"><?php echo e(trans('admin.mall.order.order_sn')); ?></th>
				<th width="240"><?php echo e(trans('admin.mall.order.consignee')); ?></th>
				<th><?php echo e(trans('admin.mall.order.remark')); ?></th>
				<th width="60"><?php echo e(trans('admin.mall.order.status')); ?></th>
				<th width="120"><?php echo e(trans('admin.mall.order.created_at')); ?></th>
			...
			<tr>
				...
				<td><?php echo e(trans('admin.mall.order.status_'.$value->order_status.$value->shipping_status.$value->pay_status)); ?></td>
				<td><?php echo e($value->created_at->format('Y-m-d H:i')); ?></td>
				<td>
					<a href="<?php echo e(route('admin.mall.order.show',$value->id)); ?>" class="" title="<?php echo e(trans('admin.view')); ?>"><?php echo e(trans('admin.view')); ?></a>
					<a href="<?php echo e(route('admin.mall.order.destroy',$value->id)); ?>" class="mlm delbtn"><?php echo e(trans('admin.destroy')); ?></a>
				</td>
			</tr>
