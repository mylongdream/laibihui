                        ...
                        <div class="weui-panel">
                            <div class="weui-panel__bd">
                                <div class="weui-grids">
                                    ...
                                    <?php if(auth()->user()->group && auth()->user()->group->sellcard): ?>
                                    <a href="<?php echo e(route('mobile.user.sellcard.index')); ?>" class="weui-grid">
                                        <div class="weui-grid__icon">
                                            <img class="user-menu-pic" src="<?php echo e(asset('static/image/mobile/center-icon-sellcard.png')); ?>" alt="">
                                        </div>
