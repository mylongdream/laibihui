<?php $__env->startSection('content'); ?>
    <div class="crm-tabnav">
        <ul>
            <li class="on"><a href="<?php echo e(route('crm.checkout.index')); ?>">快速收款</a></li>
        </ul>
    </div>
    <div class="crm-main">
        <form class="ajaxform" enctype="multipart/form-data" method="post" action="<?php echo e(route('crm.checkout.check')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="crm-form" style="border-top: 1px solid #dbdbdb;">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input class="input" type="text" size="50" value="" id="amount-show" readonly><span class="tdtip mlw"><span id="amount-discount"><?php echo e(auth('crm')->user()->shop->discount); ?></span> 折</span></td>
                    </tr>
                    <tr>
    ...
    <script type="text/javascript">
        $(function() {
            $(document).on("click", ".schuser", function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo e(route('crm.checkout.userinfo')); ?>",
