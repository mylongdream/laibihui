    ...
    <div class="wp" style="position: relative">
        ...
        <div class="search">
            <form class="searchform" method="get" action="<?php echo e(route('brand.shop.index')); ?>">
                <input id="searchkey" name="keyword" type="text" value="<?php echo e(request('keyword')); ?>">
    ...
    <div class="wp">
        ...
        <div class="nav_main cl" id="nv">
            <ul>
                ...
                <li class="<?php echo e(isset($curmenu) && $curmenu == 'farm' ? 'on' : ''); ?>">
                    <a href="<?php echo e(route('brand.farm.index')); ?>" title="农家乐">农家乐</a>
                </li>
            </ul>
        </div>
    </div>
