<?php $__env->startSection('content'); ?>
	<div class="crm-tabnav">
		<ul>
			<li class="on"><a href="<?php echo e(route('crm.ordercard.index')); ?>">已发行</a></li>
			<li><a href="<?php echo e(route('crm.ordercard.remain')); ?>">未发行</a></li>
		</ul>
	</div>
	<div class="crm-main">
			...
			<table>
				...
				<?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					<tr>
						...
						<td><?php echo e($value->card->user->username); ?></td>
