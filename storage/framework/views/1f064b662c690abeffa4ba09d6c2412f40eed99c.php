	...
	<form class="ajaxform" enctype="multipart/form-data" method="post" action="<?php echo e(route('admin.brand.shop.update', $shop->id)); ?>">
		...
		<div class="tbedit">
			...
			<table>
				...
				<tr>
					<td align="right"><?php echo e(trans('admin.brand.shop.username')); ?></td>
					<td><input class="txt" type="text" size="50" value="<?php echo e($shop->username); ?>" name="username"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input class="txt" type="text" size="50" value="<?php echo e($shop->openhours); ?>" name="openhours"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input class="txt" type="text" size="15" value="<?php echo e($shop->maplng); ?>" name="maplng" id="maplng"> X <input class="txt" type="text" size="15" value="<?php echo e($shop->maplat); ?>" name="maplat" id="maplat">
						<a href="javascript:;" class="clickbtn mlm" id="mapmark">点击标注</a>
						<a href="<?php echo e(route('admin.brand.shop.nearby', ['id' => $shop->id])); ?>" class="clickbtn mlm" id="nearby" title="附近店铺">附近店铺</a>
					</td>
				</tr>
				<tr>
