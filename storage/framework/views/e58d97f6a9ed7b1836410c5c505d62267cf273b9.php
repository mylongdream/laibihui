<div class="weui-tabbar">
    ...
    <a href="<?php echo e(route('mobile.brand.farm.index')); ?>" class="weui-tabbar__item<?php echo isset($curmenu) && $curmenu == 'farm' ? ' weui-bar__item_on' : ''; ?>">
        <?php if(isset($curmenu) && $curmenu == 'farm'): ?>
