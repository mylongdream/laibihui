<?php $__env->startSection('content'); ?>
	...
	<form class="ajaxform" enctype="multipart/form-data" method="post" action="<?php echo e(route('admin.crm.reward.update', $reward->id)); ?>">
		...
		<div class="tbedit">
			<div class="tbhead cl">
				<div class="z"><h3><?php echo e(trans('admin.crm.reward.edit')); ?></h3></div>
