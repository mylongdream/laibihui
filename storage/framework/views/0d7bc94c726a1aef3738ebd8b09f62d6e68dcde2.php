...
<head>
    ...
    <script type="text/javascript" src="<?php echo e(asset('static/js/jquery-1.8.3.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('static/js/jquery.form.js')); ?>"></script>
	...
	<link type="text/css" rel="stylesheet" href="<?php echo e(asset('static/js/jbox/skin/green/jbox.css')); ?>"/>
</head>
<body>
	<div class="login">
		...
		<?php endif; ?>
		<form class="ajaxform" name="myform" method="post" action="<?php echo e(route('admin.login')); ?>">
			<?php echo csrf_field(); ?>
