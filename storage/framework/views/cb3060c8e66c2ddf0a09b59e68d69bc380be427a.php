<?php $__env->startSection('content'); ?>
	<div class="itemnav">
		...
		<ul class="tab">
			...
			<li class="current"><a href="<?php echo e(route('admin.wechat.ownervote.visit')); ?>"><span>访问记录</span></a></li>
			<li><a href="<?php echo e(route('admin.wechat.ownervote.share')); ?>"><span>分享记录</span></a></li>
		</ul>
	</div>
	<form id="schform" name="schform" class="formsearch" method="get" action="<?php echo e(route('admin.wechat.ownervote.visit')); ?>">
	<div class="tbsearch">
		<dl>
			<dt>用户昵称</dt>
	...
	<form id="cpform" name="cpform" class="ajaxform" method="post" action="<?php echo e(route('admin.wechat.ownervote.visit')); ?>">
	<?php echo csrf_field(); ?>
	...
	<div class="tblist">
		...
		<table>
			<tr>
				...
				<th width="220">用户openid</th>
				<th>来源路径</th>
				<th width="120">发送IP</th>
				<th width="120">发送时间</th>
			</tr>
			<?php $__currentLoopData = $visitlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<tr>
				...
				<td><?php echo e($value->referer); ?></td>
	...
	<?php if(count($visitlist) > 0): ?>
	<div class="pgs cl">
		<div class="fixsel z">
			<button class="submitbtn" name="delsubmit" value="yes" type="submit"><?php echo e(trans('admin.destroy')); ?></button>
		</div>
		<div class="page y">
			<?php echo $visitlist->appends(['nickname' => request('nickname')])->appends(['openid' => request('openid')])->links(); ?>
