            ...
            <div class="product-box cl mtm">
                        ...
                        <ul>
                            <?php if($shop->upphoto): ?>
                                <?php $__currentLoopData = unserialize($shop->upphoto); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upphoto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li><img class="cloudzoom" data-cloudzoom = "zoomImage: '<?php echo e(uploadImage($upphoto, ['width'=>800,'height'=>800,'type'=>2])); ?>'" src="<?php echo e(uploadImage($upphoto, ['width'=>350,'height'=>350,'type'=>2])); ?>" width="350" height="350" /></li>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php else: ?>
                                <li><a href="<?php echo e(uploadImage($shop->upimage, ['width'=>800,'height'=>800,'type'=>2])); ?>"><img class="cloudzoom" src="<?php echo e(uploadImage($shop->upimage, ['width'=>350,'height'=>350,'type'=>2])); ?>" width="350" height="350" /></a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                    <div class="spec-scroll cl">
                        ...
                        <div class="items cl">
                            <ul>
                                <?php if($shop->upphoto): ?>
                                    <?php $__currentLoopData = unserialize($shop->upphoto); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upphoto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><a hidefocus="true" href="javascript:;"><img src="<?php echo e(uploadImage($upphoto, ['width'=>50,'height'=>50,'type'=>2])); ?>" width="50" height="50" /></a></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php else: ?>
                                    <li><a hidefocus="true" href="javascript:;"><img src="<?php echo e(uploadImage($shop->upimage, ['width'=>50,'height'=>50,'type'=>2])); ?>" width="50" height="50" /></a></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                ...
                <div class="product-intro">
                    ...
                    <div class="p-price">
                        <dl class="cl">
                            <dt>折扣：</dt>
                            <dd><em>￥</em><span><?php echo e($shop->discount); ?></span>折</dd>
                        </dl>
                        <div class="qrcode trigger-hover">
                            ...
                            <div class="qrcode-box">
                                ...
                                <img src="<?php echo e(route('brand.shop.qrcode', $shop->id)); ?>" width="250" height="250" />
                            </div>
                        </div>
                    </div>
                    <div class="p-line">
                        <dl class="cl">
                            <dt>有效期：</dt>
                            <dd>
                                <?php if($shop->started_at): ?>
                                    <?php if($shop->ended_at): ?>
                                        <?php echo e($shop->started_at->format('Y-m-d H:i')); ?> 至  <?php echo e($shop->ended_at->format('Y-m-d H:i')); ?>

                                    <?php else: ?>
                                        <?php echo e($shop->started_at->format('Y-m-d H:i')); ?> 至 长期
                                    <?php endif; ?>
                                <?php else: ?>
                                    <?php if($shop->ended_at): ?>
                                        截止至  <?php echo e($shop->ended_at->format('Y-m-d H:i')); ?>
                    ...
                    <div class="p-line">
                        <dl class="cl">
                            <dt>地址：</dt>
                            <dd><?php echo e($shop->address); ?></dd>
                        </dl>
                    </div>
                    <div class="p-line">
                        <dl class="cl">
                            <dt>电话：</dt>
                            <dd><?php echo e($shop->phone); ?></dd>
                        </dl>
                    </div>
                    <div class="p-line">
                        <dl class="cl">
                            <dt>营业时间：</dt>
                            <dd><?php echo e($shop->openhours ? $shop->openhours : '暂无'); ?></dd>
                        </dl>
                    </div>
                    <div class="p-btns cl">
                        <div class="product-appoint"><a href="<?php echo e(route('brand.shop.appoint', $shop->id)); ?>" class="openwindow" title="立即预约">立即预约</a></div>
                    </div>
                </div>
            </div>
            <div class="cl ct_shop mtm">
                ...
                <div class="main">
                            ...
                            <div class="bd">
                                <ul>
                                    <?php $__currentLoopData = unserialize($shop->pic_zizhi); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upphoto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li><img src="<?php echo e(uploadImage($upphoto)); ?>" alt=""></li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="shop-intro mtm">
                        ...
                        <div class="bd">
                            <div style="overflow: hidden"><?php echo $shop->message; ?></div>
                        </div>
                    </div>
...
<?php $__env->startSection('script'); ?>
    ...
    <script type="text/javascript" src="<?php echo e(asset('static/js/jquery.CloudZoom.js')); ?>"></script>
