        ...
        <div class="wp">
            <div class="pbw">
                ...
                <div class="weui-tab" id="tab">
                    ...
                    <div class="weui-tab__panel">
                        <div class="weui-tab__content">
                            <form class="ajaxform" name="myform" method="post" action="<?php echo e(route('mobile.login')); ?>">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="weui-cells weui-cells_form">
                                    ...
                                    <div class="weui-cell weui-cell_vcode">
                                        ...
                                        <div class="weui-cell__ft">
                                            <img class="weui-vcode-img verify-img" src="<?php echo e(captcha_src('mobile')); ?>">
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="quick-nav">
                    ...
                    <div class="y"><a href="<?php echo e(route('mobile.register', ['ReturnUrl' => request('ReturnUrl')])); ?>">立即注册</a></div>
                </div>
            </div>
        </div>
    </div>
