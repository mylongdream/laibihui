<?php $__env->startSection('content'); ?>
    <div class="crm-tabnav">
        <ul>
            <li><a href="<?php echo e(route('crm.account.index')); ?>">个人资料</a></li>
            <li class="on"><a href="<?php echo e(route('crm.account.password')); ?>">密码安全</a></li>
        </ul>
    </div>
    <div class="crm-main">
        <div class="crm-infobox">
            ...
            <div class="bd crm-form">
                <form class="ajaxform" enctype="multipart/form-data" method="post" action="<?php echo e(route('crm.account.password')); ?>">
                    <?php echo csrf_field(); ?>
