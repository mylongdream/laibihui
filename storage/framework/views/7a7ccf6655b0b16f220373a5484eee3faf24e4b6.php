	...
	<div class="tblist">
		...
		<table>
			...
			<tr>
				...
				<td>
					<a href="<?php echo e(route('admin.user.user.group',$value->uid)); ?>" class="openwindow" title="<?php echo e(trans('admin.user.user.group')); ?>"><?php echo e(trans('admin.user.user.group')); ?></a>
					<a href="<?php echo e(route('admin.user.user.edit',$value->uid)); ?>" class="mlm openwindow" title="<?php echo e(trans('admin.user.user.edit')); ?>"><?php echo e(trans('admin.edit')); ?></a>
				</td>
			</tr>
