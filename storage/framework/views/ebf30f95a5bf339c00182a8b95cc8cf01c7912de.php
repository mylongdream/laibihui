<?php $__env->startSection('content'); ?>
	...
	<form class="ajaxform" enctype="multipart/form-data" method="post" action="<?php echo e(route('admin.extend.card.store')); ?>">
		<?php echo csrf_field(); ?>

		<div class="tbedit">
			<div class="tbhead cl">
				<div class="z"><h3><?php echo e(trans('admin.extend.card.create')); ?></h3></div>
				<div class="y"><a href="<?php echo e(route('admin.extend.card.index')); ?>" class="btn">< <?php echo e(trans('admin.extend.card.list')); ?></a></div>
			</div>
			<table>
				<tr>
					<td width="150" align="right"><?php echo e(trans('admin.extend.card.length')); ?></td>
				...
				<tr>
					...
					<td><input class="txt" type="text" size="30" value="1000" name="count"><span class="tdtip">最多可以生成10000张</span></td>
				</tr>
				<tr>
					<td width="150" align="right"><?php echo e(trans('admin.extend.card.pwdlength')); ?></td>
					<td><input class="txt" type="text" size="30" value="8" name="pwdlength"><span class="tdtip">最长可以为20位</span></td>
				</tr>
				<tr>
					<td width="150" align="right"><?php echo e(trans('admin.extend.card.money')); ?></td>
