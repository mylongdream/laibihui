<?php $__env->startSection('content'); ?>
	...
	<form class="ajaxform" enctype="multipart/form-data" method="post" action="<?php echo e(route('admin.brand.allot.store', ['shopid' => request('shopid')])); ?>">
		<?php echo csrf_field(); ?>

		<div class="tbedit">
			<div class="tbhead cl">
				<div class="z"><h3><?php echo e(trans('admin.brand.allot.create', ['shopid' => request('shopid')])); ?></h3></div>
