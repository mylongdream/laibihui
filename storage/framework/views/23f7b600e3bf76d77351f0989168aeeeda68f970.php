    ...
    <div class="weui-tab">
        <div class="wp">
            <div class="pbw">
                ...
                <form class="ajaxform" name="myform" method="post" action="<?php echo e(route('mobile.user.appoint.cancel', $appoint->order_sn)); ?>">
                    <?php echo csrf_field(); ?>

                    <div class="weui-panel weui-panel_access">
                        <div class="weui-panel__bd">
                            <a href="<?php echo e(route('mobile.brand.shop.show', ['id' => $appoint->shop->id])); ?>" class="weui-cell weui-cell_access">
                                <div class="weui-cell__hd" style="position: relative;margin-right: 10px;">
                                    <img src="<?php echo e(uploadImage($appoint->shop->upimage)); ?>" style="width: 50px;height: 50px;display: block">
                                </div>
                                <div class="weui-cell__bd">
                                    <p><?php echo e($appoint->shop ? $appoint->shop->name : '/'); ?></p>
                                    <p style="font-size: 13px;color: #888888;">电话：<?php echo e($appoint->shop ? $appoint->shop->phone : '/'); ?></p>
                                </div>
