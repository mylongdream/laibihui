                ...
                <form class="ajaxform" enctype="multipart/form-data" method="post" action="<?php echo e(route('crm.checkcustomer.check',$customer->id)); ?>">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($customer->maplng); ?> X <?php echo e($customer->maplat); ?>

                                <a href="<?php echo e(route('crm.shop.nearby', ['catid' => $customer->catid, 'maplng' => $customer->maplng, 'maplat' => $customer->maplat])); ?>" class="openwindow clickbtn mlm" id="nearby" title="附近店铺">附近店铺</a>
                            </td>
                        </tr>
                        <tr>
