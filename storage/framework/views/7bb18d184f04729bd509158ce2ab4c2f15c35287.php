<?php $__env->startSection('content'); ?>
    <div class="crm-checkout" style="width:640px;">
        <form class="ajaxform" enctype="multipart/form-data" method="post" action="<?php echo e(route('crm.checkout.pay')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="receivable">应收金额：<strong id="receivable_money"><?php echo e(request('amount')); ?></strong> 元</div>
            <?php if(0): ?>
            <div class="crm-form">
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <span class="tdtip mlw">当前可用余额为 <span id="user_money"><?php echo e($userinfo->user_money); ?></span> 元</span>
                        </td>
                    </tr>
                </table>
            </div>
            <div class="stillneed">还需支付：<strong id="stillneed_money"><?php echo e(request('account')); ?></strong> 元</div>
            <?php endif; ?>
            <div class="crm-form">
                <table>
                    <tr>
