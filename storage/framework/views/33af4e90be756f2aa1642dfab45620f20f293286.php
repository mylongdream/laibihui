<?php $__env->startSection('content'); ?>
	...
	<form class="ajaxform" enctype="multipart/form-data" method="post" action="<?php echo e(route('admin.farm.package.store', ['farm_id' => request('farm_id')])); ?>">
		<?php echo csrf_field(); ?>

		<div class="tbedit">
			<div class="tbhead cl">
                <div class="z"><h3><?php echo e(trans('admin.farm.package.create')); ?></h3></div>
			...
			<table>
				...
				<tr>
					...
					<td><?php echo e($farm->name); ?>

		<input type="hidden" name="farm_id" value="<?php echo e($farm->id); ?>" /></td>
				</tr>
				<tr>
