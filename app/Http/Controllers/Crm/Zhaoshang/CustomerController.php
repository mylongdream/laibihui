...
class CustomerController extends CommonController
{
    ...
    public function destroy(Request $request, $id)
    {
        ...
        if ($request->ajax()){
            ...
            return view('layouts.crm.message', ['status' => 1, 'info' => '删除客户成功', 'url' => back()->getTargetUrl()]);
        }
    }
    ...
    public function nearby(Request $request)
    {
        ...
        return view('crm.zhaoshang.customer.nearby', ['shops' => $shops]);
    }
    ...
    public function refer(Request $request, $id)
    {
        ...
        if ($customer->status != 'finish') {
            if ($request->ajax()){
                ...
                return view('layouts.crm.message', ['status' => 0, 'info' => '客户尚未完成', 'url' => back()->getTargetUrl()]);
            }
        }
