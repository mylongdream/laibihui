...
class CardRewardController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('mobile.crm.tuiguang.cardreward.index', ['list' => $list]);
    }

    public function record(Request $request)
    {
        $list = CommonCardRewardModel::orderBy('created_at', 'desc')->paginate(20);
        return view('mobile.crm.tuiguang.cardreward.record', ['list' => $list]);
    }
    ...
    public function exchange(Request $request)
    {
        if($request->isMethod('POST')){
            ...
            return view('mobile.crm.tuiguang.cardreward.exchange');
        }
    }
