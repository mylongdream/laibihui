...
class AddressController extends Controller
{
    ...
    public function create(Request $request)
    {
        if (auth()->user()->addresses->count() >= $this->address_maxnum){
            if ($request->ajax()){
                return response()->json(['status' => 0, 'info' => trans('user.address.limited'), 'url' => route('user.address.index')]);
            }else{
                return view('layouts.user.message', ['status' => 0, 'info' => trans('user.address.limited'), 'url' => route('user.address.index')]);
            }
        }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->ajax()){
            return response()->json(['status' => '1', 'info' => trans('user.address.addsucceed'), 'url' => route('user.address.index')]);
        }else{
            return view('layouts.user.message', ['status' => '1', 'info' => trans('user.address.addsucceed'), 'url' => route('user.address.index')]);
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->ajax()){
            return response()->json(['status' => '1', 'info' => trans('user.address.editsucceed'), 'url' => route('user.address.index')]);
        }else{
            return view('layouts.user.message', ['status' => '1', 'info' => trans('user.address.editsucceed'), 'url' => route('user.address.index')]);
        }
    }
    ...
    public function destroy(Request $request, $id)
    {
        ...
        if ($request->ajax()){
            ...
            return view('layouts.user.message', ['status' => '1', 'info' => trans('user.address.deletesucceed'), 'url' => back()->getTargetUrl()]);
        }
    }
