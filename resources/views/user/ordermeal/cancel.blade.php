...
@section('content')
    @if (!request()->ajax())
        ...
        <div class="mtw">
            <div class="tbhead cl">
                <div class="z"><h3>{{ trans('user.ordercard.cancel') }}</h3></div>
            </div>
            <div class="tbedit">
                <div class="order-cancel">
                    <form class="ajaxform" enctype="multipart/form-data" method="post" action="{{ route('user.ordercard.cancel', $order->order_sn) }}">
                        {!! csrf_field() !!}
