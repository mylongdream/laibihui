...
@section('content')
	...
	<form class="ajaxform" enctype="multipart/form-data" method="post" action="{{ route('admin.farm.farm.update', $farm->id) }}">
		{!! method_field('PUT') !!}
		{!! csrf_field() !!}
		<div class="tbedit">
			<div class="tbhead cl">
			...
			<table>
				...
				<tr>
					...
					<td><input class="txt" type="text" size="15" value="{{ $farm->maplng }}" name="maplng" id="maplng"> X <input class="txt" type="text" size="15" value="{{ $farm->maplat }}" name="maplat" id="maplat">
