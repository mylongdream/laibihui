...
@section('content')
	...
	<form class="ajaxform" enctype="multipart/form-data" method="post" action="{{ route('admin.extend.coupon.store') }}">
		{!! csrf_field() !!}
		<div class="tbedit">
			<div class="tbhead cl">
			...
			<table>
				...
				<tr>
					...
					<td>
						<label class="radio use_limit_tab" for="use_limit_0">
							<input id="use_limit_0" type="radio" name="use_limit" value="0" checked> {{ trans('admin.extend.coupon.use_limit_0') }}
						</label>
						<label class="radio use_limit_tab" for="use_limit_1">
							<input id="use_limit_1" type="radio" name="use_limit" value="1" > {{ trans('admin.extend.coupon.use_limit_1') }}
						</label>
					</td>
				</tr>
				<tr class="use_limit_body">
				...
				<tr class="use_limit_body hidden">
				...
				<tr>
					...
					<td>
						<label class="radio" for="getway_oneself">
							<input id="getway_oneself" type="radio" name="getway" value="oneself" checked> {{ trans('admin.extend.coupon.getway_oneself') }}
						</label>
						<label class="radio" for="getway_register">
							<input id="getway_register" type="radio" name="getway" value="register" > {{ trans('admin.extend.coupon.getway_register') }}
						</label>
					</td>
				</tr>
				<tr>
