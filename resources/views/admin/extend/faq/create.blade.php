...
@section('content')
	...
	<form class="ajaxform" enctype="multipart/form-data" method="post" action="{{ route('admin.extend.faq.store') }}">
		{!! csrf_field() !!}
		<div class="tbedit">
			<div class="tbhead cl">
			...
			<table>
				...
				<tr>
					...
					<td><textarea class="textarea" name="message" cols="60" rows="5"></textarea></td>
				</tr>
				<tr>
