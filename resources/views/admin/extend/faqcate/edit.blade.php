...
@section('content')
	...
	<form class="ajaxform" enctype="multipart/form-data" method="post" action="{{ route('admin.extend.faqcate.update', $faqcate->id) }}">
		...
		<div class="tbedit">
			...
			<table>
				<tr>
					...
					<td><input class="txt" type="text" size="50" value="{{ $faqcate->name }}" name="name"></td>
				</tr>
				<tr>
					<td width="150" align="right">{{ trans('admin.displayorder') }}</td>
					<td><input class="txt" type="text" size="50" value="{{ $faqcate->displayorder }}" name="displayorder"></td>
				</tr>
				<tr>
					<td align="right"></td>
