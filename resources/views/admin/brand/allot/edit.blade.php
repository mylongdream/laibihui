...
@section('content')
    ...
    <form class="ajaxform" enctype="multipart/form-data" method="post" action="{{ route('admin.brand.allot.update', ['shopid' => request('shopid'), 'id' => $allot->id]) }}">
        {!! method_field('PUT') !!}
        {!! csrf_field() !!}
        <div class="tbedit">
            <div class="tbhead cl">
                <div class="z"><h3>{{ trans('admin.brand.allot.edit', ['shopid' => request('shopid'), 'id' => $allot->id]) }}</h3></div>
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><input class="txt" type="text" size="50" value="{{ $allot->quantity }}" name="quantity"></td>
                </tr>
                <tr>
                    <td align="right">{{ trans('admin.brand.allot.price') }}</td>
                    <td><input class="txt" type="text" size="30" value="{{ $allot->price }}" name="price"> 元</td>
                </tr>
                <tr>
                    <td align="right"></td>
