...
@section('content')
	...
	<form class="ajaxform" enctype="multipart/form-data" method="post" action="{{ route('admin.brand.category.move', $category->id) }}">
		{!! csrf_field() !!}
		<div class="tbedit">
			<div class="tbhead cl">
				<div class="z"><h3>{{ trans('admin.brand.category.move') }}</h3></div>
