...
@section('content')
	...
	<form class="ajaxform" enctype="multipart/form-data" method="post" action="{{ route('admin.subweb.store') }}">
		{!! csrf_field() !!}
		<div class="tbedit">
			<div class="tbhead cl">
				<div class="z">
			...
			<table>
				...
				<tr>
					...
					<td><input class="txt" type="text" size="50" value="" name="fullletter"></td>
				</tr>
				<tr>
					<td width="150" align="right">{{ trans('admin.subweb.firstletter') }}</td>
					<td><input class="txt" type="text" size="50" value="" name="firstletter" maxlength="1" style="text-transform: uppercase;"></td>
				</tr>
				<tr>
					<td width="150" align="right">{{ trans('admin.subweb.directory') }}</td>
					<td><input class="txt" type="text" size="50" value="" name="directory"></td>
				</tr>
				<tr>
					<td width="150" align="right">{{ trans('admin.subweb.domain') }}</td>
					<td><input class="txt" type="text" size="50" value="" name="domain"></td>
				</tr>
				<tr>
					<td width="150" align="right">{{ trans('admin.subweb.mappoint') }}</td>
					<td><input class="txt" type="text" size="29" value="" name="mappoint" id="mappoint"><a href="javascript:;" class="mapmark" id="mapmark">点击标注</a></td>
				</tr>
				<tr>
					<td width="150" align="right">{{ trans('admin.subweb.statcode') }}</td>
					<td><textarea class="textarea" name="statcode" cols="60" rows="5"></textarea></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<label class="radio" for="ifhot_1">
							<input id="ifhot_1" type="radio" name="ifhot" value="1"> {{ trans('admin.yes') }}
						</label>
						<label class="radio" for="ifhot_0">
							<input id="ifhot_0" type="radio" name="ifhot" value="0" checked> {{ trans('admin.no') }}
						</label>
					</td>
				</tr>
				<tr>
					...
					<td>
						<label class="radio" for="bbclosed_1">
							<input id="bbclosed_1" type="radio" name="bbclosed" value="1"> {{ trans('admin.yes') }}
						</label>
						<label class="radio" for="bbclosed_0">
							<input id="bbclosed_0" type="radio" name="bbclosed" value="0" checked> {{ trans('admin.no') }}
						</label>
					</td>
				</tr>
				</tbody>
