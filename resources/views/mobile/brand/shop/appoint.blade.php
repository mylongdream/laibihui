    ...
    <div class="weui-tab">
        <div class="">
            <div class="wp pbw">
                ...
                <form class="ajaxform" name="myform" method="post" action="{{ route('mobile.brand.shop.appoint', ['id' => $shop->id]) }}">
                    {!! csrf_field() !!}
                    <div class="weui-cells">
                        ...
                        <div class="weui-cell">
                            ...
                            <div class="weui-cell__bd">
                                <input class="weui-input timePicker" data-start="{{ date('Y-m-d', time()) }}" data-end="{{ date('Y-m-d', time()+365*24*60*60) }}" name="appoint_at" placeholder="请输入预约时间" type="text" readonly>
                            </div>
                        </div>
                    </div>
