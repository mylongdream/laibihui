    ...
    <div class="weui-tab">
        <div class="pay-main">
            <div class="main-body">
                <div class="wp">
                    <div class="pay-form">
                        <form class="ajaxform" name="myform" method="post" action="{{ route('mobile.brand.shop.pay', ['id' => $shop->id]) }}">
                            {!! csrf_field() !!}
                            ...
                            <div class="weui-cells pay-discount">
                                <div class="weui-cell">
                                    ...
                                    <div class="weui-cell__bd">
                                        <span id="amount-discount">{{ $shop->discount }}</span>
                                    </div>
...
weui.alert('你尚未绑定联名卡', {
            buttons: [{
                label: '前去绑定',
                onClick: function(){
                    window.location.href="{{ route('mobile.user.bindcard.index') }}";
                }
            }],
            isAndroid: false
        });
...
weui.alert('你尚未登录', {
            buttons: [{
                label: '前去登录',
                onClick: function(){
                    window.location.href="{{ route('mobile.login', ['ReturnUrl'=> request()->getUri()]) }}";
                }
            }],
            isAndroid: false
        });
