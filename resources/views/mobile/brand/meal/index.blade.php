        ...
        $(function(){
            ...
            $(document).on("change", ".weui-check", function(){
                ...
                if (self.is(':checked')) {
                    ...
                    $.get("{{ route('mobile.brand.shop.meal.addcart', ['id' => $shop->id]) }}", {meal_id: self.val(), num: num}, function(data){
                        loading.hide(function() {
                            updatecart(data.total);
                        });
                    });
                } else {
                    $.get("{{ route('mobile.brand.shop.meal.delcart', ['id' => $shop->id]) }}", {meal_id: self.val()}, function(data){
                        loading.hide(function() {
                            updatecart(data.total);
                        });
                    });
