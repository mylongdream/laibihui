...
@section('content')
    <div class="weui-tab">
        <div class="wp">
            <div class="pbw">
                <form class="ajaxform" name="myform" method="post" action="{{ route('mobile.brand.farm.pay', $order->order_sn) }}">
                    {!! csrf_field() !!}
                    ...
                    <div class="weui-form-preview mtm">
                        <div class="weui-form-preview__bd">
                            ...
                            <div class="weui-form-preview__item">
                                ...
                                <span class="weui-form-preview__value">{{ $order->realname }}</span>
                            </div>
                            <div class="weui-form-preview__item">
                                <label class="weui-form-preview__label">手机号码</label>
                                <span class="weui-form-preview__value">{{ $order->mobile }}</span>
                            </div>
                        </div>
                    </div>
