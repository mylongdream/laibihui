    ...
    <div class="weui-tab">
        <div class="wp">
            <div class="pbw">
                ...
                <form class="ajaxform" name="myform" method="post" action="{{ route('mobile.crm.shop.lackcard.checkin') }}">
                    {!! csrf_field() !!}
                    ...
                    <div class="weui-btn-area">
                        ...
                        <a href="{{ route('mobile.crm.shop.lackcard.index') }}" class="weui-btn weui-btn_default">订卡记录</a>
                    </div>
                </form>
            </div>
        </div>
