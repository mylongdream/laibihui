        ...
        <div class="wp">
            <div class="pbw">
                ...
                <div class="weui-msg" style="background:#fff;padding:15px 10px;">
                    ...
                    <div class="">
                        <h2 class="weui-msg__title">{{ $shop->getsuperior->realname ? $shop->getsuperior->realname : $shop->getsuperior->username }}</h2>
                    </div>
                </div>
                    <div class="weui-cells">
                        @if ($shop->getsuperior->mobile)
                        <a href="tel:{{ $shop->getsuperior->mobile }}" class="weui-cell weui-cell_access">
