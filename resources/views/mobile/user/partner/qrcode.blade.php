            ...
            <div class="pbw">
                ...
                @else
                    ...
                    <div class="weui-article">
                        ...
                        <p><a href="{{ route('mobile.user.partner.apply') }}">立即在线申请推广售卡服务</a></p>
                        <p>立即拨打客服电话<a href="tel:057188253203">0571-88253203</a>申请推广售卡服务</p>
                        @endif
                        <h2>奖励说明：</h2>
                        <p>推荐一位消费者成功办理来必惠商家联名卡每张提成5元佣金。</p>
                        <p>授权（推荐）一位消费者成功加入售卡推广员可获得7.5元每位的高额佣金。</p>
                        <p>推荐（授权）佣金上不封顶，可实时提现到银行卡。</p>
                        <p>加入售卡推广员的更多福利请点击：<a href="{{ route('mobile.brand.faq.index') }}">在线客服</a>进行查看。</p>
