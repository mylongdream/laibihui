                    ...
                    <div class="shop-sdlist mtm">
                        ...
                        <div class="bd">
                            <ul>
                                ...
                                <li>
                                    <div class="s-pic"><a href="{{ route('brand.shop.detail', $newshop->id) }}" target="_blank" title="{{ $newshop->name }}"><img width="120" height="120" border="0" src="{{ uploadImage($newshop->upimage) }}"></a></div>
                                    <div class="s-info">
                                        <div class="s-name"><a href="{{ route('brand.shop.detail', $newshop->id) }}" target="_blank" title="{{ $newshop->name }}">{{ $newshop->name }}</a></div>
                        ...
                        <div class="bd">
                            <ul>
                                @foreach ($hotshops as $hotshop)
                                    <li>
                                        <div class="s-pic"><a href="{{ route('brand.shop.detail', $hotshop->id) }}" target="_blank" title="{{ $hotshop->name }}"><img width="120" height="120" border="0" src="{{ uploadImage($hotshop->upimage) }}"></a></div>
                                        <div class="s-info">
                                            <div class="s-name"><a href="{{ route('brand.shop.detail', $hotshop->id) }}" target="_blank" title="{{ $hotshop->name }}">{{ $hotshop->name }}</a></div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $(".shop-comment-list").load("{{ route('brand.shop.comment', $shop->id) }}");
            $(".shop-comment-list").on("click", ".pagination a", function(){
                var self = $(this);
