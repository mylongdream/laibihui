    ...
    <div class="content-body">
        <div class="wp">
            <div class="order-body">
                ...
                <form class="ajaxform" enctype="multipart/form-data" method="post" action="{{ route('brand.card.order') }}">
                    {!! csrf_field() !!}
                    ...
                    <div class="order-address cl">
                        ...
                        <div class="bd cl">
                            ...
                            <div class="address-add">
                                <a href="{{ route('user.address.create') }}" class="openwindow" title="添加新地址"><span>添加新地址</span></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="order-options order-goods">
                        <table width="100%" class="cl">
                            <tr>
                                <td width="150">
                                    <a href="{{ route('brand.card.index') }}" title="我要办卡"><img height="60" src="{{ asset('static/image/common/card.jpg') }}"></a>
                                </td>
                                <td>
                                    <p><a href="{{ route('brand.card.index') }}" title="我要办卡"><span style="font-size: 14px;color: #333;">知惠网联名卡（一张能在几百家店打折的卡）</span></a></p>
                                </td>
                                <td width="100">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $(document).on("click", ".address-item", function(){
                ...
                $.ajax({
                    type: "GET",
                    url: "{{ route('brand.card.addressinfo') }}",
                    ...
                    if(data.status == 0){
                        ...
                        if (data.info) {
                            $.jBox.tip(data.info, 'success', {
                                closed: function () {
                                    $.jBox.close();
                                    $(".address-list").load("{{ route('brand.card.addresslist') }}", function(){
