    ...
    <div class="content-body">
        <div class="wp">
            <div class="order-body">
                <form class="" enctype="multipart/form-data" method="post" action="{{ route('brand.card.pay', $order->order_sn) }}">
                    {!! csrf_field() !!}
                    ...
                    <div class="order-options cl">
                        ...
                        <div class="bd">
                            <ul>
                                <li class="on">
                                    <span>{{ $order->address->realname }} {{ $order->address->mobile }} </span>
                                    <span class="mlm">{{ $order->address->getprovince ? $order->address->getprovince->name : '' }} {{ $order->address->getcity ? $order->address->getcity->name : '' }} {{ $order->address->getarea ? $order->address->getarea->name : '' }} {{ $order->address->getstreet ? $order->address->getstreet->name : '' }} {{ $order->address->address }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
