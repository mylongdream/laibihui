...
(function (window, undefined) {
    ...
    K.options = {
        ...
        items : [
            ...
            'justifyfull', 'insertorderedlist', 'insertunorderedlist', 'indent', 'outdent', 'removeformat', '|',
            'image', 'multiimage', 'flash', 'media', 'table', 'link', 'unlink', '|', 'fullscreen'
        ],
        ...
        fontSizeTable : ['8px', '10px', '12px', '14px', '16px', '18px', '24px', '36px', '48px', '60px'],
        htmlTags : {
            ...
            table: [
                'class', 'border', 'cellspacing', 'cellpadding', 'width', 'height', 'align', 'bordercolor',
            ...
            embed : ['class', 'src', 'width', 'height', 'type', 'loop', 'autostart', 'quality', '.width', '.height', 'align', 'allowscriptaccess', 'wmode'],
            ...
            'br,tbody,tr,strong,b,sub,sup,em,i,u,strike,s,del' : ['class']
        },
    ...
    _plugin('core', function(K) {
        ...
        self.clickToolbar('fontsize', function() {
            ...
            _each(self.fontSizeTable, function(i, val) {
                menu.addItem({
                    title : '<span style="" unselectable="on">' + val + '</span>',
                    checked : curVal === val,
                    click : function() {
